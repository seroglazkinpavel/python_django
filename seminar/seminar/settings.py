...
# SECRET_KEY = 'django-insecure-v^l6$r^^d7h-^02_7etf+ksv3)6z+n4z1m$77g)z1&bpxhpb#)'
...
ALLOWED_HOSTS = [
    '127.0.0.1',
    'seroglazkinpavel.pythonanywhere.com'
]
...
DATABASES = {
    'default': {
        ...
        'NAME': 'seroglazkinpavel$default',
        'USER': 'seroglazkinpavel',
        'PASSWORD': os.getenv('MYSQL_PASSWORD'),
        'HOST': 'seroglazkinpavel.mysql.pythonanywhere-services.com',
        'OPTIONS': {
