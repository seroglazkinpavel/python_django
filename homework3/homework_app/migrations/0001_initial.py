    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('modified_date', models.DateTimeField(auto_now=True)),
                ('customer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='order', to='homework_app.customer')),
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='order', to='homework_app.product')),
            ],
        ),
    ]
